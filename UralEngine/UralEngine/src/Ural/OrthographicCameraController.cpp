...
namespace Ural {
 ...
 void SetProjection(float left, float right, float bottom, float top);
    ...
    {
        if (Input::IsKeyPressed(UL_KEY_A))
         {
             m_CameraPosition.x -= m_CameraTranslationSpeed * ts;
         } else if (Ural::Input::IsKeyPressed(UL_KEY_D))
         {
             m_CameraPosition.x += m_CameraTranslationSpeed * ts;
         }

         if (Input::IsKeyPressed(UL_KEY_W))
         {
             m_CameraPosition.y += m_CameraTranslationSpeed * ts;
         } else if (Ural::Input::IsKeyPressed(UL_KEY_S))
         {
             m_CameraPosition.y -= m_CameraTranslationSpeed * ts;
         }
        ...
        if (m_Rotation)
        {
            if (Input::IsKeyPressed(UL_KEY_Q))
            {
                m_CameraRotation += m_CameraRotationSpeed * ts;
            }

            if (Input::IsKeyPressed(UL_KEY_E))
            {
                m_CameraRotation -= m_CameraRotationSpeed * ts;
            }
